...
#define STRING_CONFIG_H_AUTHOR "(Eddie, ULTIMAKER)" // Who made the changes.
#define STRING_SPLASH STRING_VERSION " www.geeetech.com " STRING_URL // will be shown during bootup
